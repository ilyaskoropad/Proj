	...
	<Div class="General">	
		...
		<Div class="Block_Body">	
			<Form  method="post" >
					...
					<P class="P_Null" style="margin-top: 0;"><?php echo $MailError; ?></P>
					...
					<P class="P_Null" style="margin-top: 0;"><?php echo $SekretError; ?></P>
					<P class="P_Null">О себе</P>
					<textarea name="_O_Sebe" class="Type_Text_Area"></textarea>
					<P class="P_Null" style="margin-top: 0;"><?php echo $OError; ?></P>
